...
import com.example.movieapp.movies.MoviesFragment
import com.example.movieapp.tvshows.TvShowsFragment
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.bncvHomeNavigation.setNavigationChangeListener { _, position ->
            when (position) {
    ...
    private val className: String
        get() = "com.example.favorite.FavoriteFragment"
